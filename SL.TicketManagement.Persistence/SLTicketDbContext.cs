...
using SL.TicketManagement.Domain.Common;
...
{
    public class SLTicketDbContext :DbContext
    {
        public SLTicketDbContext(DbContextOptions<SLTicketDbContext> options):base(options) { }
        ...
        {
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(SLTicketDbContext).Assembly);
